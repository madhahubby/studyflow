...
export function TestDetailsClient({ testId }: { testId: string }) {
  ...
  // Improved syllabus parsing to handle both lists and single blocks of text.
                ...
                <CardContent>
                    {syllabusItems.length > 0 ? (
                        <Accordion type="multiple" className="w-full">
                                ...
                                <AccordionItem value={`item-${index}`} key={index}>
                                    ...
                                    <AccordionContent>
                                        <div className="flex justify-between items-center pl-4">
                                            ...
                                            <Button size="sm" variant="outline" onClick={() => handleStudyTopic(item, item)}>
                         ...
                         <p className="text-sm text-muted-foreground italic">{test.syllabus || "No syllabus details found for this test."}</p>
                    )}
                </CardContent>
            </Card>
        </div>
